...
def Factory(params, Model):
    ...
    return ApplyLevelForceProcessOpenMP(Model, params["Parameters"])

class ApplyLevelForceProcessOpenMP(KratosMultiphysics.Process):
    '''
    ...
    def _EvaluateLevelForces(self, l_id):
        ...
        for node in self.level_forces[l_id]['nodes']:
